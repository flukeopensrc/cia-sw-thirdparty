...
extern void AllSPoll(int board_desc, const Addr4882_t addressList[],
                     short resultList[]);
extern void AllSpoll(int board_desc, const Addr4882_t addressList[],
                     short resultList[]);
...
extern void PPollConfig(int board_desc, Addr4882_t address, int dataLine,
                        int lineSense);
extern void PPollUnconfig(int board_desc, const Addr4882_t addressList[]);
extern void RcvRespMsg(int board_desc, void* buffer, long count,
                       int termination);
...
extern void SendList(int board_desc, const Addr4882_t addressList[],
                     const void* buffer,
                     long count, int eotmode);
...
extern int ibdev(int board_index, int pad, int sad, int timo, int send_eoi,
                 int eosmode);
