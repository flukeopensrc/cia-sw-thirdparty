#
# micrium_ucosii_systemh_generation.tcl
#
proc create_os_ticks_per_sec_macro {} {
    ...
    if {[string compare $timer_name "NONE"] == 0} {
        puts "ERROR: MicroC/OS II system.h generation tcl script:"
        puts " --> HAL system timer not defined. MicroC/OS-II may not build!"
        ...
        # Add to system.h content for UCOSII OS
        add_systemh_line UCOSII OS_TICKS_PER_SEC $tps_setting
    }
}
